...
public class PermissionActivity extends Activity {
  ...
  // 启动当前权限页面的公开接口
  public static void startActivityForResult(Activity activity, int requestCode, String type,
                                            String... permission) {
    typeMark = type;
...
//				allPermissionGranted();// 获取全部权限
  ...
  private void allPermissionGranted() {
    ...
    if ("CameraActivity".equals(typeMark)) {
      activityIntent = new Intent(this, CameraActivity.class);
      startActivity(activityIntent);
      finish();
    } else if ("SettingActivity".equals(typeMark)) {
  ...
  public void onRequestPermissionsResult(int requestCode,
    ...
    System.out.println("申请权限的结果：" + hasAllPermissionGranted(grantResults));
...
//				System.out.println("recogImagePath:"+picPathString);
