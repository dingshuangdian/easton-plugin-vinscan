...
@SuppressLint("NewApi") // capabilities to rotate the item.
@TargetApi(Build.VERSION_CODES.HONEYCOMB) public class RotateLayout extends ViewGroup implements Rotatable {
    ...
    public void setOrientation(int orientation) {
        ...
        System.out.println("mOrientation:"+mOrientation+"--------"+orientation);
